#ifndef DATAFRAME_CORE_VERSION_GRAPH_H
#define DATAFRAME_CORE_VERSION_GRAPH_H
...
namespace version_graph {
    ...
    public:
        ...
        void continue_chain(std::string const & from_version, std::string const & to_version, json && payload,
