...
'''
from datamodel.benchmark.datamodel import BaseSet, BaseSetProjection
import random
...
def update_test(sim):
    print "[BENCHMARK TEST]: Step %s and BaseSetProjection count %s" % (sim.curstep, len(sim.frame.get(BaseSetProjection)))
