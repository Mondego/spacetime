...
'''
from datamodel.benchmark.datamodel import BaseSet, SubsetHalf
import random
...
def update_test(sim):
    print "[BENCHMARK TEST]: Step %s and SubsetHalf count %s" % (sim.curstep, len(sim.frame.get(SubsetHalf)))
