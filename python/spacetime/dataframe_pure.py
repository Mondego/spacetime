...
from spacetime.managers.connectors.thread_socket_manager import TSocketServer as SocketServer, TSocketConnector as SocketConnector
...
class DataframePure(object):
    ...
    def __init__(
        ...
        self.versioned_heap = VersionManager(
            self.appname, types, resolver=resolver)
        if is_server:
